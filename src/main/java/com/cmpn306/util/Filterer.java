...
public class Filterer {
   ...
   public static String rawText(String html){
      return new Filterer(html).removeCss().removeHtmlTags().removeWhiteSpace().text.trim();
   }
